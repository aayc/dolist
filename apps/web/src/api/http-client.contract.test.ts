...
const CASES: Array<Case<unknown>> = [
  ...
  withCase({
    name: "deviceVault",
    method: "PUT",
    input: arb.deviceVaultRequest(),
    invoke: (c, { path }) => c.switchVault(path),
    expectSent: (body, sent) => expect(sent.body).toStrictEqual(body),
    result: self,
  }),
  withCase({
    name: "importObsidianPreview",
    method: "POST",
    input: arb.obsidianImportPreviewRequest(),
    invoke: (c, { source }) => c.previewObsidianImport(source),
    expectSent: (body, sent) => expect(sent.body).toStrictEqual(body),
    result: self,
  }),
  withCase({
    ...
    method: "GET",
    input: fc.constant(null),
    invoke: (c) => c.getObsidianImport(),
    result: self,
  }),
  withCase({
    name: "importObsidian",
    method: "POST",
    input: arb.obsidianImportRequest(),
    invoke: (c, request) => c.startObsidianImport(request),
    expectSent: (request, sent) => expect(sent.body).toStrictEqual(request),
    result: self,
  }),
  withCase({
  ...
  withCase({
    name: "importObsidianCancel",
    method: "POST",
    input: fc.constant(null),
    invoke: (c) => c.cancelObsidianImport(),
    result: self,
  }),
  withCase({
    name: "importObsidianUpdate",
    method: "POST",
    input: fc.constant(null),
    invoke: (c) => c.updateFromObsidian(),
    result: self,
  }),
  withCase({
    name: "deviceSync",
