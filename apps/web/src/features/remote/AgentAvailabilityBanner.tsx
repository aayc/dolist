...
type Banner = { kind: "unreachable" | "not_paired" | "elsewhere"; text: string } | { kind: "none" };
...
export function availabilityBanner(placement: AgentPlacementStatus | undefined): Banner {
  ...
  if (!runsOn || placement.note) return { kind: "none" };
...
export function AgentAvailabilityBanner() {
  ...
  const Icon = banner.kind === "elsewhere" ? Eye : CloudOff;
  return (
    <div
