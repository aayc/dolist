...
enum SystemShortcutConflicts {
  ...
  static let knownDefaults: [SystemShortcut] = [
    .init(
      id: "52", name: "Turn Dock hiding on/off", settingsPane: "Launchpad & Dock",
      keyCode: UInt32(kVK_ANSI_D), modifiers: [.option, .command]),
    .init(
      id: "64", name: "Show Spotlight search", settingsPane: "Spotlight",
      keyCode: UInt32(kVK_Space), modifiers: [.command]),
    .init(
      id: "65", name: "Show Finder search window", settingsPane: "Spotlight",
      keyCode: UInt32(kVK_Space), modifiers: [.option, .command]),
    .init(
      id: "60", name: "Select the previous input source", settingsPane: "Input Sources",
      keyCode: UInt32(kVK_Space), modifiers: [.control]),
    .init(
      id: "61", name: "Select next source in Input menu", settingsPane: "Input Sources",
      keyCode: UInt32(kVK_Space), modifiers: [.control, .option]),
    .init(
      id: "28", name: "Save picture of screen as a file", settingsPane: "Screenshots",
      keyCode: UInt32(kVK_ANSI_3), modifiers: [.shift, .command]),
    .init(
      id: "29", name: "Copy picture of screen to the clipboard", settingsPane: "Screenshots",
      keyCode: UInt32(kVK_ANSI_3), modifiers: [.control, .shift, .command]),
    .init(
      id: "30", name: "Save picture of selected area as a file", settingsPane: "Screenshots",
      keyCode: UInt32(kVK_ANSI_4), modifiers: [.shift, .command]),
    .init(
      id: "31", name: "Copy picture of selected area to the clipboard",
      settingsPane: "Screenshots", keyCode: UInt32(kVK_ANSI_4),
      modifiers: [.control, .shift, .command]),
    .init(
      id: "184", name: "Screenshot and recording options", settingsPane: "Screenshots",
      keyCode: UInt32(kVK_ANSI_5), modifiers: [.shift, .command]),
    .init(
      id: "32", name: "Mission Control", settingsPane: "Mission Control",
      keyCode: UInt32(kVK_UpArrow), modifiers: [.control]),
    .init(
      id: "33", name: "Application windows", settingsPane: "Mission Control",
      keyCode: UInt32(kVK_DownArrow), modifiers: [.control]),
    .init(
      id: "79", name: "Move left a space", settingsPane: "Mission Control",
      keyCode: UInt32(kVK_LeftArrow), modifiers: [.control]),
    .init(
      id: "81", name: "Move right a space", settingsPane: "Mission Control",
