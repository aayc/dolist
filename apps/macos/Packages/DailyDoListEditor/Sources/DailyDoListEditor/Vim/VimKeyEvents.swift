...
enum VimKeyEvents {
  ...
  static func input(for event: NSEvent) -> VimKeyInput? {
    ...
    if let named = namedKeys[event.keyCode] {
      ...
      guard
        let characters = control || command ? event.charactersIgnoringModifiers : event.characters,
        !characters.isEmpty, !isFunctionKeyCharacter(characters)
      else { return nil }
      key = characters
    }
    return VimKeyInput(
      key: key, control: control, alt: flags.contains(.option), meta: command,
  ...
  static let namedKeys: [UInt16: String] = [
    ...
    109: "F10",
    103: "F11", 111: "F12", 105: "F13", 107: "F14", 113: "F15", 106: "F16", 64: "F17", 79: "F18",
    80: "F19", 90: "F20",
  ]
  ...
  static let codes: [UInt16: String] = [
    ...
    8: "KeyC", 9: "KeyV",
    11: "KeyB", 12: "KeyQ", 13: "KeyW", 14: "KeyE", 15: "KeyR", 16: "KeyY", 17: "KeyT", 31: "KeyO",
    32: "KeyU",
    34: "KeyI", 35: "KeyP", 37: "KeyL", 38: "KeyJ", 40: "KeyK", 45: "KeyN", 46: "KeyM",
    18: "Digit1", 19: "Digit2", 20: "Digit3", 21: "Digit4", 23: "Digit5", 22: "Digit6",
    26: "Digit7", 28: "Digit8",
    25: "Digit9", 29: "Digit0",
    24: "Equal", 27: "Minus", 30: "BracketRight", 33: "BracketLeft", 39: "Quote", 41: "Semicolon",
    42: "Backslash",
