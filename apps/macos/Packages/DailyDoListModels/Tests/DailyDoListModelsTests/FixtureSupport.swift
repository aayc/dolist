...
enum Fixtures {
  ...
  static let models: [String: any (Codable & Equatable & Sendable).Type] = [
    ...
    "CreateRoutineRequest": CreateRoutineRequest.self,
    "DeviceSettingsPatch": DeviceSettingsPatch.self,
    "DeviceSettingsResponse": DeviceSettingsResponse.self,
    ...
    "ObsidianImportPreview": ObsidianImportPreview.self,
    ...
    "PairingCodeRequest": PairingCodeRequest.self,
    "PairingCodeResponse": PairingCodeResponse.self,
    "PostMessageRequest": PostMessageRequest.self,
    "RenameRequest": RenameRequest.self,
    "RoutineListResponse": RoutineListResponse.self,
    "RoutineRunResponse": RoutineRunResponse.self,
