...
| `routines` | GET | `/api/routines` | — | 200 [`RoutineListResponse`](#routinelistresponse) |
| `routines` | POST | `/api/routines` | [`CreateRoutineRequest`](#createroutinerequest) | 201 [`RoutineResponse`](#routineresponse) |
| `routine` | GET | `/api/routines/:id` | — | 200 [`RoutineResponse`](#routineresponse) |
| `routineRun` | POST | `/api/routines/:id/run` | — | 200 [`RoutineRunResponse`](#routinerunresponse) |
| `routinePause` | POST | `/api/routines/:id/pause` | — | 200 [`RoutineResponse`](#routineresponse) |
| `routineResume` | POST | `/api/routines/:id/resume` | — | 200 [`RoutineResponse`](#routineresponse) |
